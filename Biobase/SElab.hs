...
-- | The module provides everything necessary for low-level handling of CMs and
-- HMMs as used by Infernal and HMMER developed by the Sean Eddy lab.
--
-- TODO needs classy lenses for common names, or qualified names, or exporting
